...
import HalfcommitHalfcommitHalfcommit from './halfcommit/halfcommit.halfcommit'
...
export default { 
  ...
  HalfcommitHalfcommitHalfcommit: load(HalfcommitHalfcommitHalfcommit, 'halfcommit.halfcommit'),
